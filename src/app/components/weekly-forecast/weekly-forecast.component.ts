...
import { TemperatureUnit, WeeklyForecastEntry } from '../../models/weather.models';

@Component({ selector: 'app-weekly-forecast', imports: [MatCardModule], templateUrl: './weekly-forecast.component.html', styleUrl: './weekly-forecast.component.css' })
