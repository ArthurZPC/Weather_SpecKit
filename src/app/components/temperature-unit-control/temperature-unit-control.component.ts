...
@Component({
  selector: 'app-temperature-unit-control',
  imports: [MatButtonToggleModule],
  templateUrl: './temperature-unit-control.component.html',
  styleUrl: './temperature-unit-control.component.css',
})
export class TemperatureUnitControlComponent {
  ...
  selectUnit(unit: TemperatureUnit): void {
