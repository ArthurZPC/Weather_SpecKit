...
import { CurrentTimeContext, CurrentWeather, LocationCity, LocationSearchResult, TemperatureUnit } from '../../models/weather.models';
...
export class CurrentWeatherComponent {
  ...
  submitSearch(): void { this.searchSubmitted.emit(); }
}